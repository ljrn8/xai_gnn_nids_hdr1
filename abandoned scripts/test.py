...
windows = [
    SG for SG in yield_subgraphs(proto_test_flows, window=WINDOW, linegraph=False)
]
G = windows[2]

gnne = GNNExplainer(
    feature_bank=proto_test_flows[
        proto_test_flows.columns.difference(["src", "dst", "Attack"])
