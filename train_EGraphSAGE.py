...
parser.add_argument("--n-windows", default=None, type=int)
parser.add_argument("--window", default=10_000, type=int)
...
criterion = torch.nn.BCEWithLogitsLoss(
    pos_weight=None if args.pos_weight is None else torch.FloatTensor([args.pos_weight]))
...
# training (includes logging testing and writing)
model.train_flows(
    criterion=criterion,
    epochs=args.epochs,
